...
it('exposes focused resource objects from the root client', function (): void {
    ...
    expect($client->demoAccounts())->toBeInstanceOf(DemoAccount::class);
    expect($client->expertAdvisors())->toBeInstanceOf(ExpertAdvisor::class);
    expect($client->quotas())->toBeInstanceOf(Quota::class);
    expect($client->mtServers())->toBeInstanceOf(MtServer::class);
